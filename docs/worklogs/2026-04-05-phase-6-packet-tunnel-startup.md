...
- blockers or next handoff notes:
  ...
  - the signed packet tunnel still needs real runtime validation for access to `~/.config/MacOVPN/...`; if that path is blocked by sandboxing, Phase 7 must stop and document the exact platform constraint
