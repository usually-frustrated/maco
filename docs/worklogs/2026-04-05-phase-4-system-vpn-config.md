# maco Phase 4: System VPN Configuration Layer
...
- blockers or next handoff notes:
  ...
  - Phase 6 should validate whether the packet tunnel can read the current `~/.config/maco/...` paths directly under the signed sandbox model
